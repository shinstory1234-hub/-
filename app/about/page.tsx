    ...
    <section className="mx-auto max-w-4xl px-3 md:px-5 space-y-6">
      <Card>
        ...
        <CardContent className="px-4 pb-4 pt-0 md:px-6 md:pb-6 space-y-5">
          <p className="text-sm leading-[1.6] text-muted-foreground md:text-base md:leading-8">
          ...
          <div className="rounded-lg border border-border bg-surface p-5 space-y-3 md:p-6">
            ...
            <div className="leading-[1.6] text-muted-foreground space-y-4 md:space-y-2 md:leading-7">
          ...
          <div className="rounded-lg border border-border bg-surface p-5 space-y-3 md:p-6">
            ...
            <ul className="text-sm leading-[1.6] text-muted-foreground list-disc list-inside space-y-1 md:text-[15px] md:leading-7 md:space-y-2">
          ...
          <div className="rounded-lg border-2 border-danger/50 bg-danger/10 p-5 space-y-3 md:p-6">
            ...
            <div className="leading-[1.6] text-danger/90 space-y-4 md:space-y-2 md:leading-7">
