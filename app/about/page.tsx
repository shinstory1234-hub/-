  ...
  return (
    <section className="mx-auto max-w-4xl px-3 md:px-5 space-y-6">
      <Card>
        ...
        <CardContent className="px-4 pb-4 pt-0 md:px-6 md:pb-6 space-y-5">
          ...
          <div className="rounded-lg border border-border bg-surface p-5 space-y-3 md:p-6">
            ...
            <div className="leading-7 text-muted-foreground space-y-2">
              <p className="text-sm md:text-base md:leading-8">이 블로그는 단순한 투자 기록을 넘어, <strong className="text-foreground">나만의 액티브 ETF</strong>를 설계하고 운용하는 실험적 프로젝트입니다.</p>
              <p className="text-sm md:text-base md:leading-8">국내주식, 미국주식, 매크로, 파생상품 등 다양한 자산군을 분석하고, 그 인사이트를 바탕으로 포트폴리오를 직접 구성·운용합니다.</p>
              <p className="text-sm md:text-base md:leading-8">모든 매매는 <strong className="text-foreground">모의투자</strong>로 진행되며, 실제 수익률과 포트폴리오 현황은 포트폴리오 탭에서 확인할 수 있습니다.</p>
          ...
          <div className="rounded-lg border-2 border-danger/50 bg-danger/10 p-5 space-y-3 md:p-6">
            ...
            <div className="leading-7 text-danger/90 space-y-2">
              <p className="text-sm md:text-base md:leading-8">본 블로그의 모든 콘텐츠는 <strong>개인적인 기록 및 학습 목적</strong>으로만 작성되었으며, 어떠한 경우에도 <strong>투자 권유, 매수·매도·보유 추천</strong>으로 해석될 수 없습니다.</p>
              <p className="text-sm md:text-base md:leading-8">본 콘텐츠는 <strong>투자 판단의 근거로 사용될 수 없으며</strong>, 모든 투자 결정과 그 결과에 대한 <strong>책임은 전적으로 투자자 본인</strong>에게 있습니다.</p>
              <p className="text-sm md:text-base md:leading-8">포트폴리오는 <strong>모의투자</strong>로 운용되며, 실제 투자 성과와 다를 수 있습니다. 과거 수익률이 미래 수익률을 보장하지 않습니다.</p>
              <p className="text-sm md:text-base md:leading-8">금융투자상품은 원금 손실이 발생할 수 있으며, 투자 전 <strong>본인의 투자 성향과 리스크를 반드시 확인</strong>하시기 바랍니다.</p>
            </div>
          </div>
        </CardContent>
      </Card>
